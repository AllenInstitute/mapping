...
#10_v2_HKNN_part4!
run_large_mapping(obj = my_data, naming = my_naming, alg = my_alg, path = my_path, run_full = FALSE, start = 3, end = 3, top.n.genes = 10, MI_FN = "FB_top10_pct0.9train.list.HANN_marker_index.rda")
#10_v2_HKNN_part21
...
#parts 19,20
run_large_mapping(obj = my_data, naming = my_naming, alg = my_alg, path = my_path, run_full = FALSE, start = 18, end = 19, top.n.genes = 20, MI_FN = "FB_top20_pct0.9train.list.HANN_marker_index.rda")
