#!/bin/bash
#SBATCH --job-name=v2_HKNNs_job    # Job name
...
#SBATCH --output=v2_HKNNs_job_%j.log   # Standard output and error log
...
singularity exec --bind=/scratch/fast/$SLURM_JOBID/tmp:/tmp docker://alleninst/mapping_on_hpc Rscript R_scripts/v2_HKNNs.R > logfiles/v2_HKNNs_logfile
