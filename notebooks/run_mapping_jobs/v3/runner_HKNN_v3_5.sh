#!/bin/bash
#SBATCH --job-name=HKNN_v3_5_job    # Job name
...
#SBATCH --output=logfiles/HKNN_v3_5_job_%j.log   # Standard output and error log
...
singularity exec docker://alleninst/mapping_on_hpc Rscript R_scripts/cont_v3_HKNN_5.R > logfiles/HKNN_v3_5_logfile
