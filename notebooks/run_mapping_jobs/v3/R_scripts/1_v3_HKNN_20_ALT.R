...
my_path <- "/allen/programs/celltypes/workgroups/rnaseqanalysis/clare_morris/results/marker_genes_HKNN_objects/v3/20"
#20_v3_HKNN_remainder
...
#parts 20-27
run_large_mapping(obj = my_data, naming = my_naming, alg = my_alg, path = my_path, run_full = FALSE, start = 19, end = 26, top.n.genes = 20, MI_FN = "FB_top20_pct0.9train.list.HANN_marker_index.rda")
