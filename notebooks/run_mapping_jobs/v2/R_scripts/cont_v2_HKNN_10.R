#debug the v2 5 gene marker gene HKNN code: run 4-22
...
run_large_mapping(obj = my_data, naming = my_naming, alg = my_alg, path = my_path, run_full = FALSE, top.n.genes = 10, start = 4, end = 22)
