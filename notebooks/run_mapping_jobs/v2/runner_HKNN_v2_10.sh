#!/bin/bash
#SBATCH --job-name=HKNN_v2_10_job    # Job name
...
#SBATCH --output=logfiles/HKNN_v2_10_job_%j.log   # Standard output and error log
...
singularity exec docker://alleninst/mapping_on_hpc Rscript R_scripts/cont_v2_HKNN_10.R > logfiles/HKNN_v2_10_logfile
