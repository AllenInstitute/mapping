#!/bin/bash
#SBATCH --job-name=10_flatv3_job    # Job name
...
#SBATCH --output=10_flatv3_job_%j.log   # Standard output and error log
...
mkdir $TMPDIR/tmp
singularity exec --bind=/scratch/fast/$SLURM_JOBID/tmp:/tmp docker://alleninst/mapping_on_hpc Rscript R_scripts/v3_flat_10.R > logfiles/10_flatv3_logfile
