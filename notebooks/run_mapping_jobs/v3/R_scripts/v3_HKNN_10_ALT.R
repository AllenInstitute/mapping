...
#10_v3_HKNN_part12
run_large_mapping(obj = my_data, naming = my_naming, alg = my_alg, path = my_path, run_full = FALSE, start = 11, end = 11, top.n.genes = 10, MI_FN = "FB_top10_pct0.9train.list.HANN_marker_index.rda")
