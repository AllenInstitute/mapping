...
#5_v3_HKNN_part5
run_large_mapping(obj = my_data, naming = my_naming, alg = my_alg, path = my_path, run_full = FALSE, start = 4, end = 4, top.n.genes = 5, MI_FN = "FB_top5_pct0.9train.list.HANN_marker_index.rda")
...
#parts 21 thru 27
run_large_mapping(obj = my_data, naming = my_naming, alg = my_alg, path = my_path, run_full = FALSE, start = 20, end = 26, top.n.genes = 5, MI_FN = "FB_top5_pct0.9train.list.HANN_marker_index.rda")
