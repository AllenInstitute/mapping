#!/bin/bash
#SBATCH --job-name=v3_HKNN_job    # Job name
...
#SBATCH --output=v3_HKNN_control_job_%j.log   # Standard output and error log
...
singularity exec --bind=/scratch/fast/$SLURM_JOBID/tmp:/tmp docker://alleninst/mapping_on_hpc Rscript R_scripts/v3_HKNN_control.R > logfiles/v3_HKNN_control_logfile
