#!/bin/bash
#SBATCH --job-name=ALT_HKNN_v3_10_job    # Job name
...
#SBATCH --output=logfiles/ALT_HKNN_v3_10_job_%j.log   # Standard output and error log
...
singularity exec docker://alleninst/mapping_on_hpc Rscript R_scripts/v3_HKNN_10_ALT.R > logfiles/v3_HKNN_10_ALT_logfile
