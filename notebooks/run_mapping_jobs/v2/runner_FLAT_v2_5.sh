#!/bin/bash
#SBATCH --job-name=v2_FLAT_5_job    # Job name
...
#SBATCH --output=v2_FLAT_5_job_%j.log   # Standard output and error log
...
mkdir $TMPDIR/tmp
singularity exec --bind=/scratch/fast/$SLURM_JOBID/tmp:/tmp docker://alleninst/mapping_on_hpc Rscript R_scripts/v2_flat_5.R > logfiles/v2_FLAT_5_logfile
