#!/bin/bash
#SBATCH --job-name=SS_FLAT_5_job    # Job name
...
#SBATCH --output=SS_FLAT_5_job_%j.log   # Standard output and error log
...
mkdir $TMPDIR/tmp
singularity exec --bind=/scratch/fast/$SLURM_JOBID/tmp:/tmp docker://alleninst/mapping_on_hpc Rscript R_scripts/SS_FLAT_5.R > logfiles/SS_FLAT_5_logfile
