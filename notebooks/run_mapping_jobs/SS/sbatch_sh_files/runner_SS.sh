#!/bin/bash
#SBATCH --job-name=SS_full_job    # Job name
...
#SBATCH --output=SS_full_job_%j.log   # Standard output and error log
...
singularity exec docker://alleninst/mapping_on_hpc Rscript full_SS.R > SS_full_logfile
