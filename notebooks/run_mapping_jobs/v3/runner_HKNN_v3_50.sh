#!/bin/bash
#SBATCH --job-name=HKNN_v3_50_job    # Job name
...
#SBATCH --output=logfiles/HKNN_v3_50_job_%j.log   # Standard output and error log
...
singularity exec docker://alleninst/mapping_on_hpc Rscript R_scripts/v3_HKNN_50.R > logfiles/HKNN_v3_50_logfile
