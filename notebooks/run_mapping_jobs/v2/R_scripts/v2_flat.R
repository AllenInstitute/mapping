...
#this edition: run the v2 flat map data with default (15 genes)
...
my_path <- "/allen/programs/celltypes/workgroups/rnaseqanalysis/clare_morris/results/control_flat_objects/v2"
#setwd(my_path)
#run flat control function
run_large_mapping(obj = my_data, naming = my_naming, alg = my_alg, path = my_path, run_full = FALSE, start = 6, end = 6)
