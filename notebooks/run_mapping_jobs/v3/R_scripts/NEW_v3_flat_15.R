...
my_path <- "/allen/programs/celltypes/workgroups/rnaseqanalysis/clare_morris/results/control_flat_objects/v3/new_run"


run_large_mapping(obj = my_data, naming = my_naming, alg = my_alg, path = my_path, run_full = FALSE, start = 30, end = 30, top.n.genes = 15)
run_large_mapping(obj = my_data, naming = my_naming, alg = my_alg, path = my_path, run_full = TRUE, top.n.genes = 15)