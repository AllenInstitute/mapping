#!/bin/bash
#SBATCH --job-name=v2_FLAT_20_job    # Job name
...
#SBATCH --output=v2_FLAT_20_job_%j.log   # Standard output and error log
...
mkdir $TMPDIR/tmp
singularity exec --bind=/scratch/fast/$SLURM_JOBID/tmp:/tmp docker://alleninst/mapping_on_hpc Rscript R_scripts/v2_flat_20.R > logfiles/v2_FLAT_20_logfile
