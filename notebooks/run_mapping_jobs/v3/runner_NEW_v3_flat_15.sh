#!/bin/bash
#SBATCH --job-name=NEW_v3_flat_15_job    # Job name
...
#SBATCH --output=logfiles/NEW_v3_flat_15_job_%j.log   # Standard output and error log
...
singularity exec docker://alleninst/mapping_on_hpc Rscript R_scripts/NEW_v3_flat_15.R > logfiles/NEW_v3_flat_15_logfile
